...
function getDB() { try { return JSON.parse(localStorage.getItem(STORE) || "{}"); } catch { return {}; } }
function setDB(db) { localStorage.setItem(STORE, JSON.stringify(db)); }
function getInj() { try { return JSON.parse(localStorage.getItem(INJ_STORE) || "[]"); } catch { return []; } }
function setInj(arr) { localStorage.setItem(INJ_STORE, JSON.stringify(arr)); }
function getProfile() { try { return JSON.parse(localStorage.getItem(PROFILE_STORE) || "null"); } catch { return null; } }
function setProfile(p) { localStorage.setItem(PROFILE_STORE, JSON.stringify(p)); }
